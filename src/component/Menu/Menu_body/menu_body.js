...
const menuData = {
  ...
  Starter: [
    ...
    { name: "Vegetable Pakora", description: "Crispy deep-fried fritters made with mixed vegetables and gram flour.", price: "₹150", image: "vegetable-pakora.jpg" },
    ...
    { name: "Samosa Platter", description: "Crispy pastry filled with spiced potatoes and peas, served with chutney.", price: "₹120", image: "samosa-platter.jpg" },
  ...
  Drinks: [
    ...
    { name: "Coconut Water", description: "Fresh and natural coconut water served chilled.", price: "₹50", image: "coconut-water.jpg" },
  ...
  Thali: [
    ...
    { name: "South Indian Thali", description: "A flavorful platter with sambar, rasam, rice, papad, and chutneys.", price: "₹350", image: "south-thali.jpg" },
    { name: "Rajasthani Thali", description: "A royal platter with dal baati, churma, gatte ki sabzi, and more.", price: "₹450", image: "rajasthani-thali.jpg" },
  ],
  Other: [
    ...
    { name: "Pav Bhaji", description: "Spiced vegetable mash served with buttery pav buns.", price: "₹120", image: "pav-bhaji.jpg" },
    ...
    { name: "Rajma Chawal", description: "Comforting red kidney bean curry served with steamed rice.", price: "₹200", image: "rajma-chawal.jpg" },
    { name: "Kadhi Chawal", description: "Gram flour and yogurt-based curry served with steamed rice.", price: "₹180", image: "kadhi-chawal.jpg" },
  ],
};
